...
contract Staker {
  ...
  uint256 public currentBlockTime = block.timestamp;
  ...
  */
  ...
  /*
  Time to "reset-time" on our local testnet
  */
  function resetTime() public {
    currentBlockTime = block.timestamp;
    withdrawalDeadline = currentBlockTime + 180 seconds;
    claimDeadline = currentBlockTime + 600 seconds;
  }
